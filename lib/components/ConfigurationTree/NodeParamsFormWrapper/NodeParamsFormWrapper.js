  ...
  return (
    <div className="node-params-form-wrapper">
      <div className="node-params-form-wrapper-header">
        {
          // count is used to force remouting of icon component
          // due to some strange issues with svg rerendering
          // while switching configuration tree side modal icons
          // were missing randomly
          // eslint-disable-next-line no-plusplus
          <Icon key={counter++} icon={type} className="node-params-form-wrapper-header__icon" />
        }
      </div>
